...
def test_task_constructor(test_list_task_data):
    ...
    test_task = cv.task(list_task_response[0]['id'],
                        list_task_response[0]['parent'])
...
def test_list_task_data():
    return [{'arch': 'i386',
            ...
            'parent': 37492841,
            'priority': 19,
            'request': ['tasks/2847/37492847/kernel-3.10.0-1160.32.1.el7.1964556.test.cki.src.rpm',
                        67194,
                        'i686',
                        False,
                        {'repo_id': 5081187}],
            'result': [{'brootid': 7490808,
                        'logs': ['tasks/3015/37493015/build.log',
                                'tasks/3015/37493015/root.log',
                                'tasks/3015/37493015/state.log',
                                'tasks/3015/37493015/mock_output.log'],
                        'rpms': ['tasks/3015/37493015/kernel-headers-3.10.0-1160.32.1.el7.1964556.test.cki.i686.rpm'],
                        'srpms': []}],
